...
export const DASHBOARD_CARDS = [
  ...
  { icon: 'FileText' as const, title: 'Resume Builder', desc: 'Input academic parameters to build ATS-compatible resumes and download ReportLab PDFs.', href: ROUTES.RESUME_BUILDER, color: 'bg-indigo-500/10 text-indigo-455 border-indigo-500/20 hover:border-indigo-500/40' },
