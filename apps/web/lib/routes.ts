...
export const SIDEBAR_ITEMS = [
  ...
  { icon: 'Mic' as const, label: 'Voice Mentor', href: ROUTES.VOICE_MENTOR, color: 'text-red-400' },
...
export const DASHBOARD_CARDS = [
  ...
  { icon: 'Bot' as const, title: 'AI Mentor Advice', desc: 'Get specialized counseling and interview suggestions in your regional language.', href: ROUTES.MENTOR, color: 'bg-cyan-500/10 text-cyan-455 border-cyan-500/20 hover:border-cyan-500/40' },
  { icon: 'Mic' as const, title: 'Voice Mentor', desc: 'Speak questions to our speech synthesizer and listen to real-time audio guidance replies.', href: ROUTES.VOICE_MENTOR, color: 'bg-red-500/10 text-red-455 border-red-500/20 hover:border-red-500/40' },
